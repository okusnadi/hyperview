...
var HvSelectMultiple = (function(_PureComponent) {
  _inherits(HvSelectMultiple, _PureComponent);
  function HvSelectMultiple(props) {
    _classCallCheck(this, HvSelectMultiple);
    var _this = _possibleConstructorReturn(
      this,
      (
        HvSelectMultiple.__proto__ || Object.getPrototypeOf(HvSelectMultiple)
      ).call(this, props),
    );
    _this.onToggle = function(selectedValue) {
          ...
          [_reactNative.View, props].concat(
            _toConsumableArray(
              Render.renderChildren(
                ...
                animations,
                onUpdate,
                _extends({}, options, { onToggle: this.onToggle }),
              ),
            ),
          ),
        );
  ...
  return HvSelectMultiple;
})(_react.PureComponent);
HvSelectMultiple.namespaceURI = Namespaces.HYPERVIEW;
HvSelectMultiple.localName = _types.LOCAL_NAME.SELECT_MULTIPLE;
exports.default = HvSelectMultiple;
